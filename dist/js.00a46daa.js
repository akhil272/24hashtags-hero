...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.onMouseMoveEv = function () {
      ...
      _this.cursorConfigs.y.previous = _this.cursorConfigs.y.current = mouse.y; //set cursor opacity to 1 when hoverd on screen
      ...
      _this.onScaleMouse(); //request set animation
  ...
  _createClass(Cursor, [{
    ...
    value: function setVideo(el) {
      ...
      var siblings = (0, _utils.getSiblings)(video); // console.log(src, "Hover on this item");
